...
- (void)configureWithPlatformType:(SSDKPlatformType)type appInfo:(NSMutableDictionary *)appInfo {
    switch (type) {
        case SSDKPlatformTypeSinaWeibo:
            [appInfo SSDKSetupSinaWeiboByAppKey:@"174229287"
                                      appSecret:@"b266e6915d07bc28bc8598f636789e9d"
                                    redirectUri:@"http://www.sharesdk.cn"
                                       authType:SSDKAuthTypeBoth];
            break;
        case SSDKPlatformTypeWechat:
            [appInfo SSDKSetupWeChatByAppId:@"wx81c7327c8951204c"
                                  appSecret:@"5bb1e3c58e5b221480864e741ab3b4a0"];
            break;
        case SSDKPlatformTypeQQ:
            [appInfo SSDKSetupQQByAppId:@"1106173985"
                                 appKey:@"fjQtSqmMQ9dU0d5j"
