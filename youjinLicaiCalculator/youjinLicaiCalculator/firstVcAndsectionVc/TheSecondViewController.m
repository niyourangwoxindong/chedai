...
//    _threeArr = [[NSMutableArray alloc]initWithObjects:@"推荐车贷计算器给好友",@"给车贷计算器评分",@"当前版本号", nil];
    _threeArr = [[NSMutableArray alloc]initWithObjects:@"推荐车贷计算器给好友",@"当前版本号", nil];
...
//    }
    if (indexPath.row == 0)
    {
        ...
        [manager shareInView:self.view text:@"不然你又被各种费用套路！！！！！" image:[UIImage imageNamed:@"hone_icon_chedai"] url:@"https://www.youjin360.com/mobile/page/loanCar.html" title:@"快来下载车贷计算器" objid:nil];
    }
}
